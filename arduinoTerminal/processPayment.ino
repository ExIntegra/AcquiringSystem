                    ...
                    String uid_String)   ///< uidString - уникальный номер rdif-метки (банковской карты)
{
  ...
  int quantityPoints = 4;                                   // Количество точек, последовательно выведенных на экран
  ...
  for (int j = 0; j < quantityPoints; j++)                    // Цикл для выведения точек для имитации загрузки терминала.
  {
