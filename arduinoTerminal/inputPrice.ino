...
void inputPrice(char customKey,         ///< Символ, введеный с клавиатуры
                ...
                String &priceString)    ///< Буффер для пинкода
{
  ...
  if(customKey && flag == true)                           // Если клавиша нажата на терминале И флаг блокировки клавиатуры true, то вводим сумму к оплате
  {
